                    ...
                    <div class="box-tools pull-right">
                        <c:choose>
                            <c:when test="${not empty public1}">
                                <a href="/customer/public" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                            </c:when>
                            <c:otherwise>
                                <a href="/customer/my" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
