                ...
                <div class="box-body no-padding">
                    <table class="table">
                        <tr>
                            ...
                            <td>${saleChance.salesName}</td>
                            <td class="td_title">价值</td>
                            <td><fmt:formatNumber value="${saleChance.salesValue}"/> </td>
                            <td class="td_title">当前进度</td>
                            <td>
                                ${saleChance.currentProgress}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/saleChance/my/new/record" id="recordForm" method="post">
            ...
            <div class="modal fade" id="changeProgressModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/saleChance/my/${saleChance.id}/progress/update" id="updateProgressForm">
